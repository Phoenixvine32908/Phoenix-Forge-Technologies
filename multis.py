...
def transform_json(input_data):
    ...
    if len(statelist_nums) != total_blocks:
        raise ValueError("Liczba elementów w statelist nie zgadza się z wymiarami struktury.")
...
def gen_output(data):
    ...
    for aisle in data["structure"]:
        ...
        line = f'.aisle({", ".join(f'\"{row}\"' for row in rows_str)})'
...
def main():
    ...
    print("\033[31mThe constructed kubejs multiblock:\033[0m")
    print("\033[32m" + "\n".join(lines) + "\033[0m")
