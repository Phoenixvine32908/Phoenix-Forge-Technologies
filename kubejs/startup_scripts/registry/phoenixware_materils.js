...
const $FluidBuilder = Java.loadClass(
  "com.gregtechceu.gtceu.api.fluids.FluidBuilder",
);
const $FluidStorageKeys = Java.loadClass(
  "com.gregtechceu.gtceu.api.fluids.store.FluidStorageKeys",
);
const ALMOST_PURE_NEVONIAN_STEEL = Java.loadClass(
  "net.phoenix.core.common.data.materials.PhoenixMaterialSet",
);
...
const $RotorProperty = Java.loadClass(
  "com.gregtechceu.gtceu.api.data.chemical.material.properties.RotorProperty",
);
const $IngotProperty = Java.loadClass(
  "com.gregtechceu.gtceu.api.data.chemical.material.properties.IngotProperty",
);
const $ToolProperty = Java.loadClass(
  "com.gregtechceu.gtceu.api.data.chemical.material.properties.ToolProperty",
);
...
function makeLimitedMaterialWithCable(
  event,
  id,
  color,
  color2,
...
GTCEuStartupEvents.registry("gtceu:material", (event) => {
  ...
  const materials = [
    ...
    [
      ...
      0x808080,
      materialFlags,
      [GTValues.V[GTValues.ZPM], 32, 4, true],
  ...
  event
    .create("85_percent_pure_nevonian_steel")
    .ingot()
    .color(0xffffe0)
  ...
  event
    ...
    .flags(GTMaterialFlags.DISABLE_DECOMPOSITION);
  event
    .create("polarity_flipped_bismuthite")
    .ore()
    .dust()
    .color(0xe4d6ff)
    .iconSet("diamond")
    .flags(GTMaterialFlags.DISABLE_DECOMPOSITION);
  event
    .create("void_touched_tungsten_steel")
    .ingot()
    .liquid(3100)
  ...
  event
    ...
    .iconSet("radioactive");
  event
    .create("supercritical_carbon_dioxide")
    .fluid()
    .color(0x70a070)
    .secondaryColor(0x90c090)
    .iconSet("dull");
  event
    .create("critical_steam")
    .gas()
    .color(0xf0f8ff)
    .secondaryColor(0xadd8e6)
    .iconSet("dull");
  event
    .create("spent_uranium_235")
    .ingot()
    .color(0x603030)
  ...
  event
    ...
    .iconSet("fiery_bronze");
  event
    .create("depleted_uranium")
    .ingot()
    .color(0x555030)
    .secondaryColor(0x333010)
    .iconSet("radioactive");
  event
    .create("hot_sodium_potassium")
    .liquid(3800)
    .color(0xff4500)
    .secondaryColor(0xffd700)
    .iconSet("dull");
  event
    .create("exotic_fission_concentrate")
  ...
  event
    .create("exotic_fissile_materials_clump")
  ...
  event
    .create("rhodium_palladium_solution")
    .fluid()
  ...
  event
    .create("technetium_strontium_solution")
    .fluid()
  ...
  event
    .create("gaseous_fission_byproducts")
    .gas()
  ...
  event
    .create("purified_radioactive_waste_fluid")
    .fluid()
  ...
  event
    .create("neutralized_waste_fluid")
    .fluid()
  ...
  event
    .create("radioactive_waste_fluid") // From depleted plutonium recycling
    .fluid()
  ...
  event
    .create("fission_products_fluid")
    .fluid()
    .color(0x306030)
    .secondaryColor(0x609060)
    .iconSet("radioactive");
  event
    .create("depleted_thorium")
    .ingot()
    .color(0x505050)
    ...
    .iconSet("dull");
  event
    .create("radioactive_sludge")
    .fluid()
    .color(0x283228)
    .secondaryColor(0x405040)
    .iconSet("radioactive");
  event
    .create("radioactive_gas_mixture")
    .gas()
    .color(0x502050)
  ...
  event
    .create("frost_reinforced_stained_steel")
    .ingot()
    .fluid()
    .color(0xadd8e6)
  ...
  event
    .create("low_level_radioactive_waste")
    .ingot()
    .color(0x262a23)
  ...
  // Fluid Materials
  event.create("hafnium_chloride").fluid().color(0xc0c0c0).iconSet("bright");

  event.create("source_of_magic").fluid().color(0x8f00ff).iconSet("bright");

  event
    .create("medium_pressure_fissile_steam")
    .fluid()
    .color(0x7da10e)
    .iconSet("bright");
  event
    .create("high_level_radioactive_waste")
    .ingot()
    .color(0x778877)
  ...
  event
    .create("cryo_zirconium_binding_solution")
    .fluid()
    .color(0x80b0cc)
    .secondaryColor(0xa0d0e0)
    .iconSet("dull");
  event
    .create("cryo_graphite_binding_solution")
    .fluid()
    .color(0x507080)
    .secondaryColor(0x7090a0)
    .iconSet("dull");
  event.create("honey_catalyst").fluid().color(0xfff9e3).iconSet("dull");
  event.create("sugar_water").fluid().color(0xfffff0).iconSet("dull");
  ...
  event
    .create("ammonium_bisulfate_solution")
    .fluid()
    .color(0xf0f0f0)
    .iconSet("dull");
  event
    .create("honey_comb_base_mixture")
    .fluid()
  ...
  event
    ...
    .iconSet("dull");
  event
    .create("pollen_concentrate_fluid")
    .fluid()
    .color(0xffc200) // Light Gray/White
    .iconSet("dull");
  event
    .create("polymethyl_methacrylate")
    .ingot()
    .polymer()
    .fluid()
    .color(0xf0f8ff)
    ...
    .iconSet("dull");
  event
    .create("methyl_methacrylate")
    .fluid()
    .color(0xe8f8f8)
    .secondaryColor(0xf5ffff)
    .iconSet("dull");
  event
    .create("concentrated_sulfuric_acid")
    .fluid()
    .color(0xff8c00)
    .iconSet("dull");
  ...
  event
    ...
    .iconSet("dull");
  event
    .create("advanced_quin_naquadian_alloy")
    .ingot()
    .liquid(7400)
    .color(0x000000)
  ...
  event
    .create("extremely_modified_space_grade_steel")
    .ingot()
    .liquid(6500)
    .color(0xad6161)
    ...
    .components(
      "4x source_imbued_titanium",
      "2x ruthenium",
      "4x space_grade_steel",
      "1x radon",
    )
  ...
  GTMaterials.Silver.setProperty(
    $PropertyKey.ROTOR,
    new $RotorProperty(200, 1000, 2.0, 50),
  );
  ...
  GTMaterials.Protactinium.setProperty(
    $PropertyKey.INGOT,
    new $IngotProperty(),
  );
