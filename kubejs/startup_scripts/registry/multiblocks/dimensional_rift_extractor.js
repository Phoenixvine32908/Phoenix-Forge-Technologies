GTCEuStartupEvents.registry("gtceu:recipe_type", (phoenixvine) => {
  phoenixvine
    .create("dimensional_anchoring12")
    .category("dim")
    .setEUIO("in")
  ...
  phoenixvine
    .create("aetherial_fabrication12")
    .category("dim")
    .setEUIO("in")
...
GTCEuStartupEvents.registry("gtceu:machine", (phoenixvine) => {
  phoenixvine
    .create("dimensional_anchor12", "multiblock")
    ...
    .pattern((definition) =>
      FactoryBlockPattern.start()
        ...
        .where("E", Predicates.blocks("gtceu:source_imbued_titanium_frame"))
  ...
  phoenixvine
    .create("aetherial_fabricator12", "multiblock")
    .rotationState(RotationState.NON_Y_AXIS)
    ...
    .pattern((definition) =>
      FactoryBlockPattern.start()
        ...
        .where(
          "E",
          Predicates.blocks("gtceu:frost_reinforced_stained_steel_frame"),
        )
