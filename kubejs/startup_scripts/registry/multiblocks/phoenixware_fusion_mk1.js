...
GTCEuStartupEvents.registry("gtceu:machine", (phoenixvine) => {
  phoenixvine
    .create("phoenixware_fusion_mk1", "multiblock")
    ...
    .appearanceBlock(() =>
      Block.getBlock("kubejs:strongest_rhodium_plated_machne_casing"),
    )
    .pattern((definition) =>
      FactoryBlockPattern.start()
        ...
        .aisle(
          "#BBBBBBBBIIEIIBBBBBBBB#",
          "#FAAAAAAHHAAAHHAAAAAAG#",
          "#FAAAAAHAAHHHAAHAAAAAG#",
          "#FAAAAAAHHAAAHHAAAAAAG#",
          "#BBBBBBBBIIEIIBBBBBBBB#",
        )
        .aisle(
          "#BBBBBBBIIEJEIIBBBBBBB#",
          "#FAAAAAHAAAAAAAHAAAAAG#",
          "#FAAAAHFHHAKAHHFHAAAAG#",
          "#FAAAAAHAAAAAAAHAAAAAG#",
          "#BBBBBBBIIEJEIIBBBBBBB#",
        )
        .aisle(
          "BBBBBBBIIEJJJEIIBBBBBBB",
          "DAAAAAHAAAAAAAAAHAAAAAD",
          "DAAAAHAHKAAKAAKHAHAAAAD",
          "DAAAAAHAAAAAAAAAHAAAAAD",
          "BBBBBBBIIEJJJEIIBBBBBBB",
        )
        .aisle(
          "BBBBBBIIEJJJJJEIIBBBBBB",
          "DAAAAAHAAAAAAAAAHAAAAAD",
          "DAAAAHAHAKAKAKAHAHAAAAD",
          "DAAAAAHAAAAAAAAAHAAAAAD",
          "BBBBBBIIEJJJJJEIIBBBBBB",
        )
        .aisle(
          "CBBBBIIEJJJCJJJEIIBBBBC",
          "EAAAAHAAAAAAAAAAAHAAAAE",
          "EAAAHAHAAAKKKAAAHAHAAAE",
          "EAAAAHAAAAAAAAAAAHAAAAE",
          "CBBBBIIEJJJCJJJEIIBBBBC",
        )
        .aisle(
          "CBBBBIEJJJCCCJJJEIBBBBC",
          "EAAAAHAAAAAKAAAAAHAAAAE",
          "EAAAHAHKKKKLKKKKHAHAAAE",
          "EAAAAHAAAAAKAAAAAHAAAAE",
          "CBBBBIEJJJCCCJJJEIBBBBC",
        )
        .aisle(
        ...
        .where(
          "B",
          Predicates.blocks("kubejs:strongest_rhodium_plated_machne_casing"),
        )
        ...
        .where(
          ...
          Predicates.blocks("gtceu:fusion_casing")
            ...
            .or(
              Predicates.blocks(
                PartAbility.INPUT_ENERGY.getBlocks(GTValues.ZPM).toArray(),
