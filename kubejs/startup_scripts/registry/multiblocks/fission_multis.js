GTCEuStartupEvents.registry("gtceu:recipe_type", (phoenixvine) => {
  phoenixvine
    .create("pressurized_fission_reactor")
    .category("fission")
    .setEUIO("out")
  ...
  phoenixvine
    .create("advanced_pressurized_fission_reactor")
    .category("fission")
  ...
  phoenixvine
    .create("high_performace_breeder_reactor")
    .category("fission")
    .setEUIO("out")
...
GTCEuStartupEvents.registry("gtceu:machine", (phoenixvine) => {
  phoenixvine
    .create("heat_exchanger", "multiblock")
    ...
    .pattern((definition) =>
      FactoryBlockPattern.start()
        ...
        .where(
          "C",
          Predicates.blocks("kubejs:fissile_heat_safe_casing")
            .setMinGlobalLimited(6) // Corrected line
  ...
  phoenixvine
    .create("pressurized_fission_reactor", "multiblock")
    .rotationState(RotationState.NON_Y_AXIS)
    ...
    .appearanceBlock(() =>
      Block.getBlock("kubejs:fissile_reaction_safe_casing"),
    )
    .pattern((definition) =>
      FactoryBlockPattern.start()
        ...
        .where(
          "C",
          Predicates.blocks("kubejs:fissile_reaction_safe_casing")
            .setMinGlobalLimited(12) // Corrected line
            .or(Predicates.autoAbilities(definition.getRecipeTypes()))
            .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1)),
        )
  ...
  phoenixvine
    .create("advanced_pressurized_fission_reactor", "multiblock")
    .rotationState(RotationState.NON_Y_AXIS)
  ...
  phoenixvine
    .create("high_performace_breeder_reactor", "multiblock")
    .rotationState(RotationState.NON_Y_AXIS)
