GTCEuStartupEvents.registry("gtceu:recipe_type", (phoenixvine) => {
  phoenixvine
    .create("reborn_dimensional_rift_extractor")
    .category("multiblock")
    .setEUIO("in")
...
GTCEuStartupEvents.registry("gtceu:machine", (phoenixvine) => {
  phoenixvine
    .create("reborn_dimensional_rift_extractor", "multiblock")
      ...
      FactoryBlockPattern.start()
        ...
        .where(
          ...
          Predicates.blocks("kubejs:reliable_naquadah_alloy_machine_casing")
            ...
            .or(
              Predicates.abilities(PartAbility.INPUT_LASER).setMaxGlobalLimited(
                1,
              ),
            )
