...
GTCEuStartupEvents.registry("gtceu:machine", (phoenixvine) => {
  phoenixvine
    .create("comb_decanter", "multiblock")
  ...
  phoenixvine
    .create("swarm_nuturer", "multiblock")
    .rotationState(RotationState.NON_Y_AXIS)
  ...
  phoenixvine
    .create("apis_progenitor", "multiblock")
    .rotationState(RotationState.NON_Y_AXIS)
  ...
  phoenixvine
    .create("simulated_colony", "multiblock")
    .rotationState(RotationState.NON_Y_AXIS)
