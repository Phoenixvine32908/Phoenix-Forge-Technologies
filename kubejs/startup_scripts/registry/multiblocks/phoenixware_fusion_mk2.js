...
GTCEuStartupEvents.registry("gtceu:machine", (phoenixvine) => {
  phoenixvine
    .create("phoenixware_fusion_mk2", "multiblock")
    .machine((holder) => new $FusionReactorMachine(holder, GTValues.UIV))
    ...
    .pattern((definition) =>
      FactoryBlockPattern.start()
        ...
        .aisle(
          ...
          "BBIAAAAAAAAAAAAAAAAAIBB",
          "BBIAAAAAAAJJJAAAAAAAIBB",
          "BBIAAAAAAAAAAAAAAAAAIBB",
          "BBCCCCCCCCCCCCCCCCCCCBB",
        )
        .aisle(
          "BBCCCCCCCCKKKCCCCCCCCBB",
          "BBIAAAAAAAJJJAAAAAAAIBB",
          "BBIAAAAAJJAAAJJAAAAAIBB",
          "BBIAAAAAAAJJJAAAAAAAIBB",
          "BBCCCCCCCCKKKCCCCCCCCBB",
        )
        .aisle(
          "BCCCCCCCCKKGKKCCCCCCCCB",
          "BHAAAAAAJJAAAJJAAAAAAHB",
          "BHAAAAAJAAJJJAAJAAAAAHB",
          "BHAAAAAAJJAAAJJAAAAAAHB",
          "BCCCCCCCCKKGKKCCCCCCCCB",
        )
        .aisle(
          "BCCCCCCCKKGMGKKCCCCCCCB",
          "BHAAAAAJAAAAAAAJAAAAAHB",
          "BHAAAAJNJJAOAJJNJAAAAHB",
          "BHAAAAAJAAAAAAAJAAAAAHB",
          "BCCCCCCCKKGMGKKCCCCCCCB",
        )
        .aisle(
          "CCCCCCCKKGMMMGKKCCCCCCC",
          "EAAAAAJAAAAAAAAAJAAAAAE",
          "EAAAAJAJOAAOAAOJAJAAAAE",
          "EAAAAAJAAAAAAAAAJAAAAAE",
          "CCCCCCCKKGMMMGKPCCCCCCC",
        )
        .aisle(
          "CCCCCCKKGMMMMMGKKCCCCCC",
          "EAAAAAJAAAAAAAAAJAAAAAE",
          "EAAAAJAJAOAOAOAJAJAAAAE",
          "EAAAAAJAAAAAAAAAJAAAAAE",
          "CCCCCCKKGMMMMMGKKCCCCCC",
        )
        .aisle(
          "DCCCCKKGMMMDMMMGKKCCCCD",
          "GAAAAJAAAAAAAAAAAJAAAAG",
          "GAAAJAJAAAOOOAAAJAJAAAG",
          "GAAAAJAAAAAAAAAAAJAAAAG",
          "DCCCCKKGMMMDMMMGKKCCCCD",
        )
        .aisle(
          "DCCCCKGMMMDDDMMMGKCCCCD",
          "GAAAAJAAAAAOAAAAAJAAAAG",
          "GAAAJAJOOOOQOOOOJAJAAAG",
          "GAAAAJAAAAAOAAAAAJAAAAG",
          "DCCCCKGMMMDDDMMMGKCCCCD",
        )
        .aisle(
        ...
        .aisle(
          "BBCCCCCCCCKKKCCCCCCCCBB",
          "BAIAAAAAAAJJJAAAAAAAIBB",
          "BAIAAAAAJJAAAJJAAAAAIBB",
          "BAIAAAAAAAJJJAAAAAAAIBB",
          "BBCCCCCCCCKKKCCCCCCCCBB",
        )
        .aisle(
          "BBCCCCCCCCCCCCCCCCCCCBB",
          "BAIAAAAAAAAAAAAAAAAAIBB",
          "BAIAAAAAAAJJJAAAAAAAIBB",
          "BAIAAAAAAAAAAAAAAAAAIBB",
          "BBCCCCCCCCCCCCCCCCCCCBB",
        )
        ...
        .where(
          "G",
          Predicates.blocks("gtceu:fusion_casing_mk2")
