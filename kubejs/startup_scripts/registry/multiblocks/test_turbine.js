const $LargeTurbineMachine = Java.loadClass(
...
GTCEuStartupEvents.registry("gtceu:recipe_type", (phoenixvine) => {
  ...
  phoenixvine
    .create("confectionery_fabricator")
    .setEUIO("in")
    .setSlotOverlay(false, false, GuiTextures.SOLIDIFIER_OVERLAY)
...
GTCEuStartupEvents.registry("gtceu:machine", (phoenixvine) => {
  GTMachineUtils.registerDrum(
    GTMaterials.get("aluminfrost"),
    160000,
    "Aluminfrost Drum",
  );
  GTMachineUtils.registerCrate(
    GTMaterials.get("aluminfrost"),
    100,
    "Aluminfrost Crate",
  );
  GTMachineUtils.registerDrum(
    GTMaterials.get("frost_reinforced_stained_steel"),
    350000,
    "Frost Reinforced Drum",
  );
  GTMachineUtils.registerCrate(
    GTMaterials.get("frost_reinforced_stained_steel"),
    116,
    "Frost Reinforced Crate",
  );
  GTMachineUtils.registerDrum(
    GTMaterials.get("source_imbued_titanium"),
    750000,
  ...
  GTMachineUtils.registerDrum(
    GTMaterials.get("void_touched_tungsten_steel"),
    1300000,
  ...
  GTMachineUtils.registerDrum(
    GTMaterials.get("resonant_rhodium_alloy"),
    2300000,
  ...
  phoenixvine
    .create("thermo_generator", "simple")
    .tiers(GTValues.LV, GTValues.MV, GTValues.HV)
    .definition((tier, builder) =>
      builder
        .rotationState(RotationState.NON_Y_AXIS)
  ...
  phoenixvine
    .create("confectionery_fabricator", "simple")
  ...
  phoenixvine
    .create("test_turbine", "multiblock")
    .machine((holder) => new $LargeTurbineMachine(holder, GTValues.MAX))
    .rotationState(RotationState.NON_Y_AXIS)
      ...
      FactoryBlockPattern.start()
        ...
        .where(
          ...
          Predicates.blocks("kubejs:reliable_naquadah_alloy_machine_casing")
            ...
            .or(
              Predicates.abilities(PartAbility.MAINTENANCE).setMaxGlobalLimited(
                1,
              ),
            )
