GTCEuStartupEvents.registry('gtceu:recipe_type', allthemods => {
    allthemods.create('draconic_mk1')
    ...
    allthemods.create('draconic_mk2')
        .category('compact_draconic_reactors')
        .setEUIO('out')
        .setMaxIOSize(3, 3, 3, 3)
        .setSlotOverlay(false, false, GuiTextures.SOLIDIFIER_OVERLAY)
    ...
    allthemods.create('draconic_mk3')
        .category('compact_draconic_reactors')
        .setEUIO('out')
        .setMaxIOSize(3, 3, 3, 3)
        .setSlotOverlay(false, false, GuiTextures.SOLIDIFIER_OVERLAY)
...
GTCEuStartupEvents.registry('gtceu:machine', allthemods => {
    //mk1
    allthemods.create('compact_draconic_fusion_reactor_mk1', 'multiblock')
         // 
         .tooltips(Component.translatable('block.gtceu.draconic_fusion_reactor_mk1.desc'))
        ...
        //mk2
        allthemods.create('compact_draconic_fusion_reactor_mk2', 'multiblock')
        // 
        .tooltips(Component.translatable('block.gtceu.draconic_fusion_reactor_mk2.desc'))
       .rotationState(RotationState.NON_Y_AXIS)
       .appearanceBlock(GCYMBlocks.CASING_ATOMIC)
       .generator(true)
       .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH]) 
       ...
       allthemods.create('compact_draconic_fusion_reactor_mk3', 'multiblock')
        //
        .tooltips(Component.translatable('block.gtceu.draconic_fusion_reactor_mk3.desc'))
       .rotationState(RotationState.NON_Y_AXIS)
       .appearanceBlock(GCYMBlocks.CASING_ATOMIC)
       .generator(true)
       .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH]) 
