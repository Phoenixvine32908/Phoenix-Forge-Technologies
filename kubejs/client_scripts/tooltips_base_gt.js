...
ItemEvents.tooltip((event) => {
  const gtceuItems = Ingredient.of("@gtceu")
    .itemIds.toArray()
    .map((id) => `${id}`);
  event.addAdvanced(gtceuItems, (item, advanced, text) => {
    text.removeIf((component) => {
      const { translate } = JSON.parse(component.toJson().toString());
...
const WATERTIGHT_CASING_DT_TOOLTIP = {
  ...
  fluidoutput:
    "§7Any layer except first two (Watertight Casing - one per layer)",
...
const NON_SHIFT_TOOLTIP_GROUPS = {
  ...
  SUBTICK_AND_PERF_OC_GROUP: {
    multiblockIds: ["gtceu:large_chemical_reactor"],
    tooltipKeys: [
      "multiblock.subtickaccess1",
      "multiblock.subtickaccess2",
  ...
  NO_POWER_GROUP: {
    multiblockIds: ["gtceu:advanced_pressurized_fission_reactor"],
    tooltipKeys: ["multiblock.nopower1", "multiblock.nopower2"],
  },
  NO_OC_SUBTICK_GROUP: {
    multiblockIds: ["gtceu:simulated_colony"],
    tooltipKeys: [
      "multiblock.nooc1",
      "multiblock.nooc2",
      "multiblock.subtickaccess1",
  ...
  SUB_STATION_POWER_OUTPUT_GROUP: {
    multiblockIds: ["gtceu:high_performace_breeder_reactor"],
    tooltipKeys: [
      "multiblock.energyoutputaccess1",
      "multiblock.energyoutputaccess2",
  ...
  SUBTICK_ONLY: {
    ...
    tooltipKeys: ["multiblock.subtickaccess1", "multiblock.subtickaccess2"],
  },
};
const MULTIBLOCK_DESCRIPTION_TOOLTIPS = {
  "gtceu:large_arc_smelter": ["gtultimate.custom.tooltip_large_arc_smelter"],
  "gtceu:alchemical_imbuer": [
  ...
  "gtceu:assembly_line": ["gtultimate.custom.tooltip_assembly_line"],
  "gtceu:large_autoclave": ["gtultimate.custom.tooltip_large_autoclave"],
  "gtceu:large_brewer": ["gtultimate.custom.tooltip_large_brewer"],
  "gtceu:large_centrifuge": ["gtultimate.custom.tooltip_large_centrifuge"],
  "gtceu:large_chemical_bath": [
  ...
  "gtceu:large_cutter": ["gtultimate.custom.tooltip_large_cutter"],
  "gtceu:superheated_pyrolyzing_oven": [
  ...
  "gtceu:large_electrolyzer": ["gtultimate.custom.tooltip_large_electrolyzer"],
  "gtceu:large_electromagnet": [
  ...
  "gtceu:large_mixer": ["gtultimate.custom.tooltip_large_mixer"],
  "gtceu:large_packer": ["gtultimate.custom.tooltip_large_packer"],
  "gtceu:large_sifting_funnel": [
    "gtultimate.custom.tooltip_large_sifting_funnel",
  ],
  "gtceu:large_solidifier": ["gtultimate.custom.tooltip_large_solidifier"],
  "gtceu:large_wiremill": ["gtultimate.custom.tooltip_large_wiremill"],
  "gtceu:large_distillery": [
  ...
  "gtceu:large_extruder": ["gtultimate.custom.tooltip_large_extruder"],
  "gtceu:large_extractor": ["gtultimate.custom.tooltip_large_extractor"],
  "gtceu:large_chemical_reactor": [
    "gtultimate.custom.tooltip_large_chemical_reactor",
  ],
  "gtceu:vacuum_freezer": ["gtultimate.custom.tooltip_vacuum_freezer"],
  "gtceu:implosion_compressor": [
  ...
  "gtceu:heat_exchanger": ["gtultimate.custom.tooltip_heat_exchanger"],
  ...
  "gtceu:melferious_matrix": ["gtultimate.custom.tooltip_melferious_matrix"],
  "gtceu:aetherial_fabricator12": [
  ...
  "gtceu:simulated_colony": ["gtultimate.custom.tooltip_simulated_colony"],
  "gtceu:alloy_blast_smelter": [
  ...
  "gtceu:steam_oven": ["gtultimate.custom.tooltip_steam_oven"],
  "gtceu:steam_grinder": ["gtultimate.custom.tooltip_steam_grinder"],
  "gtceu:primitive_pump": ["gtultimate.custom.tooltip_primitive_pump"],
  "gtceu:primitive_blast_furnace": [
    "gtultimate.custom.tooltip_primitive_blast_furnace",
  ],
  "gtceu:coke_oven": ["gtultimate.custom.tooltip_coke_oven"],
};
const MACHINE_TYPE_NAMES = {
  ...
  "gtceu:advanced_pressurized_fission_reactor":
    "§eAdvanced Pressurized Fission Reactor",
  "gtceu:large_maceration_tower": "§eMacerator",
  "gtceu:large_material_press":
    "§eBending | Compressor | Forge Hammer | Forming Press",
...
const SHIFT_PLACEHOLDER_VALUES = {
  ...
  "gtceu:large_autoclave": {
    ...
    values: WATERTIGHT_CASING_TOOLTIP,
  },
  "gtceu:large_chemical_bath": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:heat_exchanger": {
    ...
    values: FISSILE_REACTION_SAFE_CASING_TOOLTIP,
  },
  "gtceu:large_steam_compressor": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:melferious_matrix": {
    ...
    values: STURDY_MACHINE_CASING_TOOLTIP,
  },
  "gtceu:dimensional_anchor12": {
    tooltipOrder: [
      "controller",
    ...
    values: STABLE_MACHINE_CASING_TOOLTIP,
  },
  "gtceu:aetherial_fabricator12": {
    tooltipOrder: [
      "controller",
    ...
    values: CLEAN_STAINLESS_STEEL_CASING_TOOLTIP,
  },
  ...
  "gtceu:large_distillery": {
    ...
    values: WATERTIGHT_CASING_DT_TOOLTIP,
  },
  ...
  "gtceu:large_assembler": {
    ...
    values: LARGE_SCALE_ASSEMBLER_CASING_TOOLTIP,
  },
  "gtceu:large_circuit_assembler": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:large_material_press": {
    ...
    values: STRESS_PROOF_CASING_TOOLTIP,
  },
  "gtceu:large_wiremill": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:large_electrolyzer": {
    ...
    values: NONCONDUCTING_CASING_TOOLTIP,
  },
  "gtceu:large_electromagnet": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:large_centrifuge": {
    ...
    values: VIBRATION_SAFE_CASING_TOOLTIP,
  },
  "gtceu:large_sifting_funnel": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:large_arc_smelter": {
    ...
    values: HIGH_TEMPERATURE_SMELTING_CASING_TOOLTIP,
  },
  "gtceu:alloy_blast_smelter": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:mega_blast_furnace": {
    ...
    values: HIGH_TEMPERATURE_SMELTING_CASING_RHF_TOOLTIP,
  },
  ...
  "gtceu:large_brewer": {
    ...
    values: CORROSION_PROOF_CASING_TOOLTIP,
  },
  ...
  "gtceu:large_cutter": {
    ...
    values: SHOCK_PROOF_CUTTING_CASING_TOOLTIP,
  },
  ...
  "gtceu:large_engraving_laser": {
    ...
    values: LASER_SAFE_ENGRAVING_CASING_TOOLTIP,
  },
  "gtceu:high_performace_breeder_reactor": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:large_maceration_tower": {
    ...
    values: SECURE_MACERATION_CASING_TOOLTIP,
  },
  ...
  "gtceu:large_mixer": {
    ...
    values: REACTION_SAFE_MIXING_CASING_TOOLTIP,
  },
  ...
  "gtceu:large_packer": {
    ...
    values: ROBUST_TUNGSTENSTEEL_MACHINE_CASING_TOOLTIP,
  },
  ...
  "gtceu:vacuum_freezer": {
    ...
    values: FROST_PROOF_ALUMINIUM_MACHINE_CASING_TOOLTIP,
  },
  "gtceu:mega_vacuum_freezer": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:large_chemical_reactor": {
    ...
    values: CHEMICALLY_INERT_PTFE_MACHINE_CASING_TOOLTIP,
  },
  ...
  "gtceu:implosion_compressor": {
    ...
    values: SOLID_MACHINE_CASING_TOOLTIP,
  },
  ...
  "gtceu:assembly_line": {
    ...
    values: SOLID_MACHINE_CASING_ASSEMBLY_LINE_TOOLTIP,
  },
  ...
  "gtceu:advanced_cracking_unit": {
    ...
    values: TUNGSTEN_STEEL_TURBINE_CASING_TOOLTIP,
  },
  "gtceu:superheated_pyrolyzing_oven": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:distillation_tower": {
    ...
    values: CLEAN_STAINLESS_STEEL_CASING_DT_TOOLTIP,
  },
  ...
  "gtceu:pyrolyse_oven": {
    ...
    values: ULV_MACHINE_CASING_TOOLTIP,
  },
  ...
  "gtceu:electric_blast_furnace": {
    ...
    values: HEAT_PROOF_INVAR_MACHINE_CASING_TOOLTIP,
  },
  "gtceu:multi_smelter": {
    tooltipOrder: [
      "controller",
  ...
  "gtceu:primitive_pump": {
    ...
    values: LOOK_AT_THE_MULTIBLOCK_PREVIEW,
  },
  "gtceu:primitive_blast_furnace": {
    tooltipOrder: ["controller"],
    values: LOOK_AT_THE_MULTIBLOCK_PREVIEW,
  ...
  "gtceu:coke_oven": {
    ...
    values: COKE_OVEN_BRICKS_TOOLTIP,
  },
  ...
  "gtceu:steam_oven": {
    ...
    values: STEAM_MACHINE_CASING_OVEN,
  },
};

function addTooltipsFromGroups(text, itemId, tooltipGroups, startIndex) {
  for (const groupName in tooltipGroups) {
    const group = tooltipGroups[groupName];
...
ItemEvents.tooltip((event) => {
  ...
  for (const groupName in NON_SHIFT_TOOLTIP_GROUPS) {
    NON_SHIFT_TOOLTIP_GROUPS[groupName].multiblockIds.forEach((id) =>
      allMultiblockIds.add(id),
    );
  }
      ...
      if (!event.shift) {
        if (MACHINE_TYPE_NAMES[item.id]) {
          text.add(
            startIndex++,
            Text.translatable(
              "multiblock.tooltip.machinetype",
              Text.of(MACHINE_TYPE_NAMES[item.id]),
            ),
          );
        }
        ...
        startIndex = addTooltipsFromGroups(
          text,
          item.id,
          NON_SHIFT_TOOLTIP_GROUPS,
          startIndex,
        );
        ...
        text.add(
          startIndex++,
          Text.translatable("multiblock.structureadvtooltip"),
        );

        if (
          multiblockInfo &&
          multiblockInfo.tooltipOrder &&
          multiblockInfo.values
        ) {
          multiblockInfo.tooltipOrder.forEach((keySuffix) => {
            ...
            if (value !== undefined) {
              text.add(
                startIndex++,
                Text.translatable(tooltipKey, Text.of(value)),
              );
            }
          });
        } else {
          console.log(
            `Debug: No Shift-Informations (tooltipOrder or values) for Item-ID: ${item.id}`,
          );
        }
      }
    });
