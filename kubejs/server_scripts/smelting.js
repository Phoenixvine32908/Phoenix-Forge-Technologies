...
ServerEvents.recipes((event) => {
  ...
  event.smelting(
    "1x gtceu:gold_iron_alloy_ingot",
    "1x gtceu:gold_iron_alloy_dust",
  );
  ...
  event.smelting(
    ...
    "1x gtceu:deepslate_dormant_ember_ore",
  );
  ...
  event.smelting(
    "1x gtceu:permafrost_dust",
    "1x gtceu:deepslate_permafrost_ore",
  );
  ...
  console.log(
    "Hello! The recipe event has fired, and charcoal recipes for all vanilla logs and wood types have been added!",
  );
});
