...
const $FluidStackJS = Java.loadClass(
...
ServerEvents.recipes((phoenixvine) => {
  function addWannaBeeRecipe(beeName, mobEntityType, upgrade) {
    const recipeBuilder = phoenixvine.recipes.gtceu
      .melferious_matrix(
        `kubejs:gtceu/melferious_matrix/wanna_${beeName.toLowerCase().replace(" ", "_")}_${upgrade.split("_").pop()}`,
      )
      ...
      .notConsumable(
        IngredientHelper.weakNBT(
          Item.of(
            ...
            `{type:"productivebees:wanna", entity: "productivebees:configurable_bee"}`,
          ),
        ).withCount(1),
      )
      .notConsumable(
        Item.of(
          ...
          `{BlockEntityTag:{EntityData:{entityType:"${mobEntityType}"}}}`,
        ).weakNBT(),
      )
  ...
  // Piglin
  const piglinRecipe = addWannaBeeRecipe(
    "Piglin",
    "minecraft:piglin",
  ...
  // Hoglin
  const hoglinRecipe = addWannaBeeRecipe(
    "Hoglin",
    "minecraft:hoglin",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Zombified Piglin
  const zombifiedPiglinRecipe = addWannaBeeRecipe(
    "Zombified Piglin",
  ...
  // Zombified Hoglin
  const zombifiedHoglinRecipe = addWannaBeeRecipe(
    "Zombified Hoglin",
    "minecraft:zombified_hoglin",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Piglin Brute
  const piglinBruteRecipe = addWannaBeeRecipe(
    "Piglin Brute",
  ...
  // Shulker
  const shulkerRecipe = addWannaBeeRecipe(
    "Shulker",
    "minecraft:shulker",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Phantom
  const phantomRecipe = addWannaBeeRecipe(
    "Phantom",
    "minecraft:phantom",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Blaze
  const blazeRecipe = addWannaBeeRecipe(
    "Blaze",
    "minecraft:blaze",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Elder Guardian
  const elderGuardianRecipe = addWannaBeeRecipe(
    "Elder Guardian",
  ...
  // Evoker
  const evokerRecipe = addWannaBeeRecipe(
    "Evoker",
    "minecraft:evoker",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Magma Cube
  const magmaCubeRecipe = addWannaBeeRecipe(
    "Magma Cube",
  ...
  // Warden
  const wardenRecipe = addWannaBeeRecipe(
    "Warden",
    "minecraft:warden",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Illager (Pillager)
  const illagerRecipe = addWannaBeeRecipe(
    "Illager",
    "minecraft:pillager",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Slime
  const slimeRecipe = addWannaBeeRecipe(
    "Slime",
    "minecraft:slime",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Vindicator
  const vindicatorRecipe = addWannaBeeRecipe(
    "Vindicator",
  ...
  // Witch
  const witchRecipe = addWannaBeeRecipe(
    "Witch",
    "minecraft:witch",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Wither Skeleton
  const witherSkeletonRecipe = addWannaBeeRecipe(
    "Wither Skeleton",
  ...
  witherSkeletonRecipe.itemOutputsRanged(
  ...
  // Creeper
  const creeperRecipe = addWannaBeeRecipe(
    "Creeper",
    "minecraft:creeper",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Zombie
  const zombieRecipe = addWannaBeeRecipe(
    "Zombie",
    "minecraft:zombie",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Skeleton
  const skeletonRecipe = addWannaBeeRecipe(
    "Skeleton",
    "minecraft:skeleton",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Spider
  const spiderRecipe = addWannaBeeRecipe(
    "Spider",
    "minecraft:spider",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Enderman
  const endermanRecipe = addWannaBeeRecipe(
    "Enderman",
    "minecraft:enderman",
    "productivebees:upgrade_productivity_2",
  );
  ...
  // Ghast
  const ghastRecipe = addWannaBeeRecipe(
    "Ghast",
    "minecraft:ghast",
    "productivebees:upgrade_productivity_2",
  );
