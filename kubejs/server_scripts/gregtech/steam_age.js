ServerEvents.recipes((event) => {
  ...
  event.recipes.gtceu
    ...
    .EUt(32);
  event.recipes.gtceu
    .assembler("luv_machine_casing")
    .circuit(8)
    .itemInputs("8x gtceu:resonant_rhodium_alloy_plate")
    .itemOutputs("1x gtceu:luv_machine_casing")
    .duration(70)
    .EUt(32);
  event.recipes.gtceu
    .assembler("iv_machine_casing")
    .circuit(8)
    .itemInputs("8x gtceu:void_touched_tungsten_steel_plate")
    .itemOutputs("1x gtceu:iv_machine_casing")
    .duration(70)
    .EUt(32);
  event.recipes.gtceu
    .assembler("ev_machine_casing")
    .circuit(8)
  ...
  event.recipes.gtceu
    ...
    .EUt(32);
  event.recipes.gtceu
    .extractor("frost_from_ingot")
    .itemInputs("1x gtceu:permafrost_ingot")
    .outputFluids("kubejs:frost 144")
    .duration(80)
    .EUt(32);
  event.recipes.gtceu
    ...
    .EUt(32);
  event.recipes.gtceu
    .assembler("steam_machine_casing")
    .circuit(6)
  ...
  event.recipes.gtceu
    ...
    .EUt(32);
  event.recipes.gtceu
    .assembler("hv_machine_casig")
    .circuit(6)
    .itemInputs("8x gtceu:frost_reinforced_stained_steel_plate")
    .itemOutputs("1x gtceu:hv_machine_casing")
    .duration(100)
    .EUt(32);
  event.recipes.gtceu
    .assembler("industrial_steam_casing")
    .circuit(6)
    ...
    .EUt(32);
  event.recipes.gtceu
    .electric_blast_furnace("aluminfrost")
    .circuit(2)
  ...
  event.recipes.gtceu
    .electric_blast_furnace("frost_reinforced_stained_steelv2")
    .circuit(2)
    ...
    .blastFurnaceTemp(1700);
  event.recipes.gtceu
    .electric_blast_furnace("frost_reinforced_stained_steelv1")
    .circuit(1)
    .itemInputs("1x gtceu:frost_reinforced_stained_steel_dust")
    .itemOutputs("1x gtceu:frost_reinforced_stained_steel_ingot")
    .blastFurnaceTemp(1700)
  ...
  event.recipes.gtceu
    .electric_blast_furnace("aluminfrost2")
    .circuit(1)
    .itemInputs("32x gtceu:unrefined_aluminfrost_dust", "1x gtceu:cobalt_dust")
    .itemOutputs("32x gtceu:aluminfrost_ingot")
    .blastFurnaceTemp(1700)
    ...
    .EUt(100);
  event.recipes.gtceu
    .electric_blast_furnace("aluminfrost_return")
    .circuit(2)
    .itemInputs("1x gtceu:aluminfrost_dust")
    ...
    .EUt(100);
  event.recipes.gtceu
    .electric_blast_furnace("aluminfrost_return2")
    .circuit(1)
    .itemInputs("1x gtceu:aluminfrost_dust")
    .itemOutputs("1x gtceu:aluminfrost_ingot")
    .blastFurnaceTemp(1700)
    ...
    .EUt(100);
  event.recipes.gtceu
    .mixer("cryo_ember_fluid")
    .circuit(1)
    .itemInputs("12x gtceu:dormant_ember_dust", "1x gtceu:permafrost_dust")
  ...
  event.recipes.gtceu
    .alloy_smelter("copper_alloy_dust_ingot")
  ...
  event.recipes.gtceu
    .alloy_smelter("copper_alloy_ingot_dust")
  ...
  event.recipes.gtceu
    .alloy_smelter("copper_alloy_dust_dust")
    .itemInputs("2x gtceu:iron_dust", "1x gtceu:copper_dust")
    .itemOutputs("enderio:copper_alloy_ingot")
    .duration(160)
    .EUt(16);
  event.recipes.gtceu
    .mixer("frost_reinforced_stained_steel_dust")
    .circuit(6)
    .itemInputs(
      "6x gtceu:iron_dust",
  ...
  event.shaped(
    "kubejs:frost_reinforced_stained_steel_drill_head",
    ["FWF", "FWF", "WCW"],
    {
      W: "gtceu:dense_steel_plate",
  ...
  event.shaped(
    "kubejs:source_imbued_titanium_drill_head",
    ["FWF", "FWF", "WCW"],
    {
