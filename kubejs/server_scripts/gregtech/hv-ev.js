ServerEvents.recipes(event => {
 ...
 event.recipes.gtceu.large_chemical_reactor("printed_accumulation_processor")
    ...
    .itemInputs('1x gtceu:zircalloy_plate','2x gtceu:frost_reinforced_stained_steel_plate', '1x gtceu:blue_steel_frame', '4x minecraft:ice')
    .circuit(6)
    ...
    .itemInputs('4x gtceu:lead_plate','1x gtceu:tempered_glass', '4x minecraft:amethyst_shard', '2x gtceu:aluminfrost_plate')
    .circuit(6)
   ...
   event.recipes.gtceu.macerator('aurum_wood_dust')
    ...
    .itemInputs('5x gtceu:zirconium_dust', '1x gtceu:small_niobium_dust', '2x gtceu:hafnium_dust')
    ...
    .chancedOutput('gtceu:low_level_radioactive_waste_ingot', 1000, 0)
    .duration(3500)
