ServerEvents.recipes((event) => {
  ...
  event.recipes.gtceu
    .earth_sieve("from_cobbled_deepslate")
  ...
  event.recipes.gtceu
    .sifter("sift_mineral_sand_traces")
  ...
  event.recipes.gtceu
    .sifter("sift_casseterite_traces")
  ...
  event.recipes.gtceu
    .sifter("sift_tetrahedrite_traces")
