ServerEvents.recipes((event) => {
  ...
  greg
    .electrolyzer("flourite_dust_to_flourine")
  ...
  greg
    .scanner("luv_confectionery_fabricator")
    .itemInputs("gtceu:iv_confectionery_fabricator", "gtceu:data_stick")
    .itemOutputs(
      Item.of(
        "gtceu:data_stick",
        '{assembly_line_research:{research_id:"1x_gtceu_iv_confectionery_fabricator",research_type:"gtceu:assembly_line"}}',
      ),
    )
    .duration(2000)
  ...
  greg
    .scanner("melferious_matrix_research")
    .itemInputs("gtceu:simulated_colony", "gtceu:data_stick")
    .itemOutputs(
      Item.of(
        "gtceu:data_stick",
        '{assembly_line_research:{research_id:"1x_gtceu_simulated_colony",research_type:"gtceu:assembly_line"}}',
      ),
    )
    .duration(2000)
    .EUt(GTValues.VA[GTValues.IV]);
  ...
  greg
    .assembly_line("melferious_matrix")
    .itemInputs(
    ...
    .inputFluids("productivebees:honey 24000", "gtceu:soldering_alloy 4000")
    .itemOutputs("gtceu:melferious_matrix")
    .stationResearch((b) =>
      b
        .researchStack("gtceu:simulated_colony")
        .EUt(131000)
        .CWUt(1, 1)
  ...
  greg
    .scanner("advanced_cracker_research")
    .itemInputs("gtceu:cracker", "gtceu:data_stick")
    .itemOutputs(
      Item.of(
        "gtceu:data_stick",
        '{assembly_line_research:{research_id:"1x_gtceu_cracker",research_type:"gtceu:assembly_line"}}',
      ),
    )
    .duration(2000)
    .EUt(GTValues.VA[GTValues.IV]);
  ...
  greg
    .assembly_line("advanced_cracker")
    .itemInputs(
  ...
  greg
    ...
    .itemInputs([
      ...
      "gtceu:small_dormant_ember_dust",
    ])
  ...
  greg
    .large_chemical_reactor("concentrated_sulfuric_acid")
  ...
  greg
    .electrolyzer("concentrated_sulfuric_acid_to_hydrogen_peroxide")
    .inputFluids("gtceu:concentrated_sulfuric_acid 1000")
    .outputFluids(
      "gtceu:hydrogen_peroxide 100",
      "minecraft:water 300",
  ...
  greg
    .large_chemical_reactor("acetone_cyanohydrin")
  ...
  greg
    .large_chemical_reactor("methyl_methacrylate")
    .inputFluids(
    ...
    .outputFluids(
      "gtceu:methyl_methacrylate 1000",
      "gtceu:ammonium_bisulfate_solution 1000",
    )
    .duration(300)
    .EUt(GTValues.VA[GTValues.IV] / 2);
  ...
  greg
    .distillation_tower("ammonium_bisulfate_solution_to_dust")
  ...
  greg
    .electrolyzer("ammonium_bisulfate_dust_to_ammonium_persulfate")
  ...
  greg
    .large_chemical_reactor("ammonium_bisulfate_solution")
  ...
  greg
    .large_chemical_reactor("advanced_pmma_polymerization")
    .inputFluids(
  ...
  greg
    .fluid_solidifier("honey_comb_base")
  ...
  greg
    .compressor("honey_comb_bases_solid")
  ...
  greg
    .alloy_blast_smelter("loquid_void_touched_tungsten_steel")
    .itemInputs(
      "4x gtceu:tungsten_dust",
      "4x gtceu:voidglass_shard_dust",
  ...
  greg
    .mixer("extremely_modified_space_grade_steel")
    .itemInputs(
  ...
  greg
    .alloy_blast_smelter("molten_extremely_modified_space_grade_steel")
    .itemInputs(
      "4x gtceu:source_imbued_titanium_dust",
      "2x gtceu:ruthenium_dust",
      "4x gtceu:space_grade_steel_dust",
  ...
  greg
    .alloy_blast_smelter("molten_extremely_modified_space_grade_steel_boosted")
    .itemInputs(
      "4x gtceu:source_imbued_titanium_dust",
      "2x gtceu:ruthenium_dust",
      "4x gtceu:space_grade_steel_dust",
  ...
  greg
    .alloy_blast_smelter("loquid_void_touched_tungsten_steel_boosted")
    .itemInputs(
      "4x gtceu:tungsten_dust",
      "4x gtceu:voidglass_shard_dust",
      "2x gtceu:molybdenum_dust",
  ...
  greg
    .mixer("resonant_rhodium_alloy")
    .itemInputs(
      "3x gtceu:rhodium_dust",
      "4x gtceu:palladium_dust",
      "2x gtceu:polarity_flipped_bismuthite_dust",
  ...
  greg
    .alloy_blast_smelter("molten_resonant_rhodium_alloy_gas")
    .itemInputs(
      "3x gtceu:rhodium_dust",
      "4x gtceu:palladium_dust",
      "2x gtceu:polarity_flipped_bismuthite_dust",
  ...
  greg
    .alloy_blast_smelter("molten_resonant_rhodium_alloy")
    .itemInputs(
      "3x gtceu:rhodium_dust",
      "4x gtceu:palladium_dust",
      "2x gtceu:polarity_flipped_bismuthite_dust",
  ...
  greg
    .large_chemical_reactor("superconductive_honey_creation")
    .itemInputs(
      "8x gtceu:honey_dust",
      "4x gtceu:niobium_titanium_dust",
  ...
  greg
    .implosion_compressor("superconductive_honey_ingot_normal")
  ...
  greg
    .implosion_compressor("superconductive_honey_ingot_itnt")
    .itemInputs(
      "1x gtceu:superconductive_honey_dust",
  ...
  greg
    .assembler("superconductive_honey_coil_block")
    .itemInputs(
      "8x gtceu:superconductive_honey_double_wire",
      "8x gtceu:hsss_foil",
    )
  ...
  greg
    .large_chemical_reactor("sugar_to_sucrose_enhanced")
  ...
  greg
    .large_chemical_reactor("sucrose_inversion")
    .inputFluids(
      "gtceu:sucrose",
      "gtceu:distilled_water 500",
      "gtceu:sulfuric_acid 10",
    )
    .circuit(4)
  ...
  greg
    .large_chemical_reactor("protein_solution_from_mince_meat")
  ...
  greg
    .large_chemical_reactor("amino_acids_from_protein_solution")
  ...
  greg
    .large_chemical_reactor("pollen_concentrate_fluid_from_flowers")
  ...
  greg
    .large_chemical_reactor("pollen_concentrate_fluid_from_plant_balls")
    .inputFluids("gtceu:ethanol 1000")
    .circuit(4)
  ...
  greg
    .large_chemical_reactor("honey_catalyst")
    .inputFluids(
      "gtceu:amino_acids 1500",
      "minecraft:water 32000",
      "gtceu:sodium_potassium 1200",
    )
    .circuit(24)
  ...
  greg
    .large_chemical_reactor("honey")
    .inputFluids(
      "gtceu:honey_catalyst 1500",
      "gtceu:invert_sugar_solution 3000",
      "gtceu:pollen_concentrate_fluid 2500",
    )
    .circuit(24)
  ...
  greg
    .distillation_tower("invert_sugar_solution_separation")
  ...
  greg
    .chemical_reactor("sugar_and_molasses_production")
  ...
  greg
    .confectionery_fabricator("honeytreat")
    .itemInputs("5x gtceu:dough", "2x minecraft:honeycomb")
    .inputFluids(
      "productivebees:honey 5000",
      "gtceu:molasses 1000",
      "gtceu:cream 500",
      "gtceu:pollen_concentrate_fluid 2500",
      "gtceu:peanut_butter 2250",
    )
  ...
  greg
    .fluid_solidifier("soldified_honey")
  ...
  event.recipes.gtceu
    .heat_exchanging("hot_nak_cooling")
  ...
  greg
    .mixer("cryo_zirconium_binding_solution")
    .inputFluids("kubejs:frost 288", "minecraft:water 2000")
    .itemInputs(
      "2x gtceu:crystallized_fluxstone_dust",
      "1x gtceu:zirconium_dust",
    )
  ...
  greg
    .mixer("cryo_graphite_binding_solution")
    .inputFluids("kubejs:frost 288", "minecraft:water 2000")
    .itemInputs(
      "2x gtceu:crystallized_fluxstone_dust",
  ...
  greg
    .large_chemical_reactor("thorium_fuel_pellet_crafting")
  ...
  greg
    .large_chemical_reactor("uranium_235_fuel_pellet_crafting")
  ...
  greg
    .large_chemical_reactor("uranium_233_fuel_pellet_crafting")
  ...
  greg
    .large_chemical_reactor("plutonium_241_fuel_pellet_crafting")
  ...
  greg
    .large_chemical_reactor("uranium_236_fuel_pellet_crafting")
  ...
  greg
    .high_performace_breeder_reactor(
      "breeder_reactor/plutonium_uranium_236_cycle",
    )
    .itemInputs(
      "4x kubejs:u236_fuel_pellet",
      "1x kubejs:plutonium_241_fuel_pellet",
    )
    ...
    .outputFluids(
      "gtceu:hot_sodium_potassium 64000",
      "gtceu:critical_steam 120000",
    )
    .duration(360)
  ...
  greg
    .large_chemical_reactor("reprocessing/irradiated_uranium_236_nuggets")
    .itemInputs("16x gtceu:irradiated_uranium_236_nugget")
    .inputFluids("gtceu:nitric_acid 1000")
    .itemOutputs(
      "10x gtceu:spent_uranium_236_dust",
      "8x gtceu:plutonium_fission_ash_dust",
    )
    .duration(300)
    .EUt(GTValues.VA[GTValues.IV]);
  ...
  greg
    .large_chemical_reactor("reprocessing/depleted_plutonium_241_nuggets")
    .itemInputs("4x gtceu:depleted_plutonium_241_nugget")
    .inputFluids("gtceu:nitric_acid 500")
    .itemOutputs(
      "2x gtceu:plutonium_241_dust",
      "1x gtceu:americium_241_dust",
      "4x gtceu:depleted_plutonium_dust",
    )
    .duration(200)
    .EUt(GTValues.VA[GTValues.IV]);
  ...
  greg
    .large_chemical_reactor("americium_hexafluoride_production")
  ...
  greg
    .high_performace_breeder_reactor(
      "breeder_reactor/thorium_uranium_233_cycle_u235_driver",
    )
  ...
  greg
    .high_performace_breeder_reactor(
      "breeder_reactor/thorium_uranium_233_cycle_u233_driver",
    )
  ...
  greg
    .large_chemical_reactor("reprocessing/thorium_rods_to_uranium_233")
  ...
  greg
    .large_chemical_reactor("reprocessing/spent_uranium_235_rods")
  ...
  greg
    .large_chemical_reactor("reprocessing/spent_uranium_233_rods")
  ...
  greg
    .distillation_tower("fission_products_fluid_processing")
  ...
  greg
    .centrifuge("radioactive_gas_mixture_separatio")
  ...
  greg
    .distillation_tower("inert_gas_waste_recycling")
  ...
  greg
    .large_chemical_reactor("plutonium_fission_ash_dissolution")
    .itemInputs("4x gtceu:plutonium_fission_ash_dust")
    .inputFluids("gtceu:aqua_regia 500", "gtceu:hydrofluoric_acid 200")
    .outputFluids(
      "gtceu:rhodium_palladium_solution 250",
      "gtceu:technetium_strontium_solution 250",
      "gtceu:radioactive_sludge 100",
      "gtceu:gaseous_fission_byproducts 100",
    )
    .duration(600)
    .EUt(GTValues.VA[GTValues.LuV]);
  ...
  greg
    .chemical_reactor("rhodium_palladium_extraction")
  ...
  greg
    .centrifuge("technetium_strontium_separation")
  ...
  greg
    .distillation_tower("gaseous_fission_byproducts_separation")
    .inputFluids("gtceu:gaseous_fission_byproducts 1000")
    .outputFluids(
      "gtceu:krypton 100",
      "gtceu:xenon 150",
      "gtceu:iodine 50",
      "gtceu:trace_fission_gases 700",
    ) // New waste fluid
    .duration(250)
    .EUt(GTValues.VA[GTValues.IV]);
  ...
  greg
    .centrifuge("radioactive_sludge_processing")
  ...
  greg
    .chemical_reactor("acidic_waste_processing")
    .inputFluids(
      "gtceu:acidic_waste 1000",
      "gtceu:calcium_hydroxide_solution 500",
    ) // Neutralize with calcium hydroxide
  ...
  greg
    .distillation_tower("trace_fission_gases_processing")
    .inputFluids("gtceu:trace_fission_gases 1000")
    .outputFluids(
      "gtceu:argon 50",
      "gtceu:neon 25",
      "gtceu:helium 25",
      "gtceu:inert_gas_waste 900",
    ) // Recover trace noble gases, remaining inert waste
    .duration(300)
    .EUt(GTValues.VA[GTValues.LuV]);

  // Recycling Depleted Plutonium (back to a usable form)
  greg
    .large_chemical_reactor("depleted_plutonium_recycling")
  ...
  greg
    .centrifuge("fissile_ash_processing")
  ...
  greg
    .electric_blast_furnace("depleted_thorium_recycling")
  ...
  greg
    .assembler("comb_decanter_recipe_assembler")
    .itemInputs(
  ...
  greg
    .assembler("apis_progenitor_recipe_assembler")
    .itemInputs(
  ...
  greg
    .assembler("swarm_nurturer_recipe_assembler")
    .itemInputs(
      "gtceu:iv_machine_hull",
      "#gtceu:circuits/iv",
  ...
  greg
    .assembler("simulated_colony_recipe_assembler")
    .itemInputs(
  ...
  greg
    .assembler("breeder_reactor_controller")
    .itemInputs(
  ...
  greg
    .assembler("iv_confectionery_fabricator")
    .itemInputs(
      "4x gtceu:void_touched_tungsten_steel_rotor",
      "1x minecraft:honeycomb",
      "2x #gtceu:circuits/iv",
      "gtceu:iv_machine_hull",
      "1x gtceu:iv_sensor",
    )
  ...
  greg
    .assembly_line("luv_confectionery_fabricator")
    .itemInputs(
      "4x gtceu:resonant_rhodium_alloy_rotor",
      "4x productivebees:honey_treat",
    ...
    .stationResearch((b) =>
      b
        .researchStack("gtceu:iv_confectionery_fabricator")
        .EUt(131000)
        .CWUt(1, 1)
        .dataStack("gtceu:data_stick"),
    )
  ...
  greg
    .assembly_line("zpm_confectionery_fabricator")
    .itemInputs(
      "4x gtceu:advanced_quin_naquadian_alloy_rotor",
      "16x productivebees:honey_treat",
    ...
    .stationResearch((b) =>
      b
        .researchStack("gtceu:luv_confectionery_fabricator")
        .EUt(131000)
        .CWUt(1, 1),
    )
  ...
  greg
    .large_chemical_reactor("exotic_fission_concentrate_production")
    .itemInputs(
      "2x gtceu:technetium_dust",
      "2x gtceu:strontium_dust",
      "4x gtceu:rare_earth_dust",
    )
  ...
  greg
    .large_chemical_reactor("advanced_quin_naquadian_alloy_synthesis")
    .itemInputs(
      "2x gtceu:naquadah_alloy_dust",
      "1x gtceu:exotic_fissile_materials_clump_dust",
      "1x gtceu:nevvonian_iron_dust",
    )
    .inputFluids("gtceu:critical_steam 500")
  ...
  greg
    .large_chemical_reactor("exotic_fissile_materials_clump_production")
    .itemInputs("1x gtceu:exotic_fission_concentrate_dust")
    .inputFluids(
      "gtceu:cryo_zirconium_binding_solution 1000",
      "gtceu:cryo_graphite_binding_solution 1000",
    )
  ...
  event.recipes.gtceu
    .mixer("midway_hostile_mob_essence_canister")
    .itemInputs(
  ...
  event.recipes.gtceu
    .mixer("full_hostile_mob_essence_canister")
    .itemInputs(
  ...
  event.recipes.gtceu
    .mixer("midway_passive_mob_essence_canister")
    .itemInputs(
    ...
    .inputFluids("productivebees:honey 250", "gtceu:cream 144")
  ...
  event.recipes.gtceu
    .mixer("full_passive_mob_essence_canister")
    .itemInputs(
  ...
  event.recipes.gtceu
    .mixer("midway_neutral_mob_essence_canister")
    .itemInputs(
    ...
    .inputFluids("thermal:ender 144", "gtceu:liquid_ender_air 100")
  ...
  event.recipes.gtceu
    .mixer("full_neutral_mob_essence_canister")
    .itemInputs(
  ...
  event.recipes.gtceu
    .assembler("empty_hostile_mob_essence_canister")
    .itemInputs(
    ...
    .inputFluids(
      "gtceu:void_touched_tungsten_steel 288",
      "productivebees:honey 500",
    )
  ...
  event.recipes.gtceu
    .assembler("empty_passive_mob_essence_canister")
    .itemInputs(
      "2x gtceu:dense_source_imbued_titanium_plate",
      "16x gtceu:source_titanium_filament_double_wire",
      "16x gtceu:superconductive_honey_double_wire",
  ...
  event.recipes.gtceu
    .assembler("empty_neutral_mob_essence_canister")
    .itemInputs(
      "2x gtceu:dense_source_imbued_titanium_plate",
      "16x gtceu:source_titanium_filament_double_wire",
      "16x gtceu:superconductive_honey_double_wire",
  ...
  event.recipes.gtceu
    .assembler("fully_charged_mob_essence_capsule_recipe")
    .itemInputs(
