...
ServerEvents.recipes(phoenix => {
    ...
    function addLuVBeeRecipes() {
        ...
        function makeLuVCombDecantingRecipe({
            ...
            const outputItems = [
                Item.of(rawWaxDustId).withCount(5),
    ...
    const finalOreItemOutputs = {
        ...
        pitchblende: Item.of("gtceu:raw_pitchblende", 5),
        cobalt: Item.of("gtceu:cobalt_dust", 5),
        ...
        amethyst: Item.of("gtceu:raw_amethyst", 5),
        realgar: Item.of("gtceu:raw_realgar", 5),
        pyrope: Item.of("gtceu:raw_pyrope", 5),
        ...
        sapphire: Item.of("gtceu:raw_sapphire", 5),
        stibnite: Item.of("gtceu:raw_stibnite", 5),
        opal: Item.of("gtceu:raw_opal", 5),
        lapis: Item.of("gtceu:raw_lapis", 5),
        electrotine: Item.of("gtceu:raw_electrotine", 5),
        coal: Item.of("gtceu:coal_ore", 5),
        ...
        tungstate: Item.of("gtceu:raw_tungstate", 5),
        emerald: Item.of("gtceu:raw_emerald", 5),
        tricalcium_phosphate: Item.of("gtceu:raw_tricalcium_phosphate", 5),
        lead: Item.of("gtceu:raw_lead", 5),
      ...
      //  experience: Item.of("crazyae2addons:xp_shard", 32),
        ...
        sculk: Item.of("minecraft:sculk", 5),
        rune: Item.of("forbidden_arcanus:rune", 5),
        warped: Item.of("minecraft:warped_wart_block", 5),
        brown_shroom: Item.of("minecraft:brown_mushroom_block", 5),
        frosty: Item.of("minecraft:snowball", 5),
        red_shroom: Item.of("minecraft:red_mushroom_block", 5),
        withered: Item.of("minecraft:wither_rose", 5),
        cheese: Item.of("ad_astra:cheese", 5),
        constantan: Item.of("thermal:constantan_ingot", 5),
        redstone: Item.of("minecraft:redstone", 5),
        skeletal: Item.of("minecraft:bone", 5),
        zombie: Item.of("minecraft:rotten_flesh", 5),
        silky: Item.of("minecraft:string", 5),
        niter: Item.of("thermal:niter_dust", 5),
        slimy: Item.of("minecraft:slime_ball", 5),
        menril: Item.of("integrateddynamics:menril_log", 5),
        crystalline: Item.of("gtceu:raw_nether_quartz", 5),
        sodalite: Item.of("gtceu:raw_sodalite", 5),
        obsidian: Item.of("minecraft:obsidian", 5),
        rocked: Item.of("gtceu:raw_rock_salt", 5),
        super_factory: Item.of("sfm:cable", 5),
        desh: Item.of("ad_astra:raw_desh", 9),
        crimson: Item.of("minecraft:crimson_fungus", 5),
        infinity: Item.of("enderio:grains_of_infinity", 5),
        spacial: Item.of("ae2:certus_quartz_crystal", 5),
        arcane_crystal: Item.of("forbidden_arcanus:arcane_crystal", 1),
        magmatic: Item.of("minecraft:magma_block", 1),
        nickel: Item.of("gtceu:raw_nickel", 5),
        fluix: Item.of("ae2:fluix_crystal", 5),
        invar: Item.of("gtceu:invar_ingot", 1),
        sticky_resin: Item.of("gtceu:sticky_resin", 5),

        // LuV Bees
        thorium: Item.of("gtceu:raw_thorium", 5),
        graphite: Item.of("gtceu:raw_graphite", 5),
        sphalerite: Item.of("gtceu:raw_sphalerite", 5),
        netherite: Item.of("minecraft:ancient_debris", 1),
        ender: Item.of("minecraft:ender_pearl", 5),
        acidic: Item.of("gtceu:sulfuric_acid_bucket", 5),
        chromite: Item.of("gtceu:raw_chromite_dust", 5),
        pyrolusite: Item.of("gtceu:raw_pyrolusite", 5),
        platinum: Item.of("gtceu:raw_platinum", 5),
        bismuth: Item.of("gtceu:bismuth_dust", 5),
        glowing: Item.of("minecraft:glowstone_dust", 5),
        bastnasite: Item.of("gtceu:raw_bastnasite", 5),
        tetrahedrite: Item.of("gtceu:raw_tetrahedrite", 5),
        titanium: Item.of("gtceu:rutile_dust", 5),
        sulfur: Item.of("gtceu:raw_sulfur", 5),
        oilsands: Item.of("gtceu:raw_oilsands", 5),
        tantalite: Item.of("gtceu:raw_tantalite", 5),
        barite: Item.of("gtceu:raw_barite", 5),
        vanadium_magnetite: Item.of("gtceu:raw_vanadium_magnetite", 5),
        draconic: Item.of("productivebees:draconic_dust", 5),
