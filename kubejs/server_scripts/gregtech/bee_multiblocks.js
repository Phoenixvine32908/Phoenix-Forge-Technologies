ServerEvents.recipes((phoenix) => {
  ...
  phoenix.recipes.gtceu
    .centrifuge("impure_honey_purification")
  ...
  function addLumberBeeRecipes() {
    const logTypes = [
      { log: "minecraft:oak_log", pollination: Item.of("minecraft:oak_log") },
      {
        ...
        pollination: Item.of("minecraft:spruce_log"),
      },
      {
        log: "minecraft:birch_log",
        pollination: Item.of("minecraft:birch_log"),
      },
      {
        log: "minecraft:jungle_log",
        pollination: Item.of("minecraft:jungle_log"),
      },
      {
        log: "minecraft:acacia_log",
        pollination: Item.of("minecraft:acacia_log"),
      },
      {
        log: "minecraft:dark_oak_log",
        pollination: Item.of("minecraft:dark_oak_log"),
      },
      {
        log: "minecraft:mangrove_log",
        pollination: Item.of("minecraft:mangrove_log"),
      },
      {
        log: "minecraft:cherry_log",
        pollination: Item.of("minecraft:cherry_log"),
      },
      {
        log: "minecraft:crimson_stem",
        pollination: Item.of("minecraft:crimson_stem"),
      },
      { log: "gtceu:rubber_log", pollination: Item.of("gtceu:rubber_log") },
      {
        log: "forbidden_arcanus:edelwood_log",
        pollination: Item.of("forbidden_arcanus:edelwood_log"),
      },
      {
        log: "forbidden_arcanus:aurum_log",
        pollination: Item.of("forbidden_arcanus:aurum_log"),
      },
      {
        log: "minecraft:warped_stem",
        pollination: Item.of("minecraft:warped_stem"),
      },
      // Ars Nouveau wood types
      {
        log: "ars_nouveau:red_archwood_log",
        pollination: Item.of("ars_nouveau:red_archwood_log"),
      },
      {
        log: "ars_nouveau:blue_archwood_log",
        pollination: Item.of("ars_nouveau:blue_archwood_log"),
      },
      {
        log: "ars_nouveau:green_archwood_log",
        pollination: Item.of("ars_nouveau:green_archwood_log"),
      },
      {
        log: "ars_nouveau:purple_archwood_log",
        pollination: Item.of("ars_nouveau:purple_archwood_log"),
      },
    ];
    logTypes.forEach((type) => {
      phoenix.recipes.gtceu
        .simulated_colony(
          `kubejs:gtceu/simulated_colony/lumber_${type.log.replace(":", "_")}`,
        )
  ...
  function addLuVBeeRecipes() {
    const LuVBeeTypes = [
      {
        luv_bee: "thorium",
        luVbeeName: "Thorium Bee",
        pollination: "gtceu:thorium_block",
        LuVoutputComb: "thorium",
      },
      {
        luv_bee: "graphite",
        luVbeeName: "Graphite Bee",
        pollination: "gtceu:raw_graphite_block",
        LuVoutputComb: "graphite",
      },
      {
        luv_bee: "sphalerite",
        luVbeeName: "Sphalerite Bee",
        pollination: "gtceu:raw_sphalerite_block",
        LuVoutputComb: "sphalerite",
      },
      {
        luv_bee: "netherite",
        luVbeeName: "Ancient Bee",
        pollination: "minecraft:ancient_debris",
        LuVoutputComb: "netherite",
      },
      {
        luv_bee: "ender",
        luVbeeName: "Ender Bee",
        pollination: "minecraft:end_stone",
        LuVoutputComb: "ender",
      },
      {
        luv_bee: "apatite",
        luVbeeName: "Apatite Bee",
        pollination: "gtceu:raw_apatite_block",
        LuVoutputComb: "apatite",
      },
      {
        luv_bee: "acidic",
        luVbeeName: "Acidic Bee",
        pollination: "gtceu:sulfuric_acid_bucket",
        LuVoutputComb: "acidic",
      },
      {
        luv_bee: "chromite",
        luVbeeName: "Chromite Bee",
        pollination: "gtceu:raw_chromite_block",
        LuVoutputComb: "chromite",
      },
      {
        luv_bee: "pyrolusite",
        luVbeeName: "Pyrolusite Bee",
        pollination: "gtceu:raw_pyrolusite_block",
        LuVoutputComb: "pyrolusite",
      },
      {
        luv_bee: "platinum",
        luVbeeName: "Platinum Bee",
        pollination: "gtceu:raw_platinum_block",
        LuVoutputComb: "platinum",
      },
      {
        luv_bee: "bismuth",
        luVbeeName: "Bismuth Bee",
        pollination: "gtceu:bismuth_block",
        LuVoutputComb: "bismuth",
      },
      {
        luv_bee: "glowing",
        luVbeeName: "Glowing Bee",
        pollination: "minecraft:glowstone",
        LuVoutputComb: "glowing",
      },
      {
        luv_bee: "bastnasite",
        luVbeeName: "Bastnasite Bee",
        pollination: "gtceu:raw_bastnasite_block",
        LuVoutputComb: "bastnasite",
      },
      {
        luv_bee: "tetrahedrite",
        luVbeeName: "Tetrahedrite Bee",
        pollination: "gtceu:raw_tetrahedrite_block",
        LuVoutputComb: "tetrahedrite",
      },
      {
        luv_bee: "sulfur",
        luVbeeName: "Sulfur Bee",
        pollination: "gtceu:raw_sulfur_block",
        LuVoutputComb: "sulfur",
      },
      {
        luv_bee: "oilsands",
        luVbeeName: "Oilsands Bee",
        pollination: "gtceu:raw_oilsands_block",
        LuVoutputComb: "oilsands",
      },
      {
        luv_bee: "cobalt",
        luVbeeName: "Cobalt Bee",
        pollination: "gtceu:raw_cobalt_block",
        LuVoutputComb: "cobalt",
      },
      {
        luv_bee: "tantalite",
        luVbeeName: "Tantalite Bee",
        pollination: "gtceu:raw_tantalite_block",
        LuVoutputComb: "tantalite",
      },
      {
        luv_bee: "barite",
        luVbeeName: "Barite Bee",
        pollination: "gtceu:raw_barite_block",
        LuVoutputComb: "barite",
      },
      {
        luv_bee: "vanadium_magnetite",
        luVbeeName: "Vanadium Magnetite Bee",
        pollination: "gtceu:raw_vanadium_magnetite_block",
        LuVoutputComb: "vanadium_magnetite",
      },
      {
        luv_bee: "draconic",
        luVbeeName: "Draconic Bee",
        pollination: "minecraft:dragon_egg",
        LuVoutputComb: "draconic",
      },
      {
        luv_bee: "pyrochlore",
        luVbeeName: "Pyrochlore Bee",
        pollination: "gtceu:raw_pyrochlore_block",
        LuVoutputComb: "pyrochlore",
      },
      {
        luv_bee: "voidglass_shard",
        luVbeeName: "Voidglass Shard Bee",
        pollination: "gtceu:raw_voidglass_shard_block",
        LuVoutputComb: "voidglass_shard",
      },
      {
        luv_bee: "crystallized_fluxstone",
        luVbeeName: "Crystallized Fluxstone Bee",
        pollination: "gtce:raw_crystalized_fluxstone_block",
        LuVoutputComb: "crystalized_fluxstonee",
      },
      {
        luv_bee: "ignisium",
        luVbeeName: "Ignisium Bee",
        pollination: "gtceu:raw_ignisium_block",
        LuVoutputComb: "ignisium",
      },
      {
        luv_bee: "sky_steel",
        luVbeeName: "Sky Steel Bee",
        pollination: "megacells:sky_steel_block",
        LuVoutputComb: "sky_steel",
      },
    ];
    ...
    function makeLuVCombDecantingRecipe({
      ...
      const inputNBT = `{EntityTag:{type:"productivebees:${bee}"}}`;
      const inputComb = Item.of(
    ...
    LuVBeeTypes.forEach((type) => {
      const LuVoutputNBT = `{EntityTag:{type:"productivebees:${type.LuVoutputComb}"}}`;
      const LuVoutputComb = Item.of(
        "productivebees:configurable_honeycomb",
        LuVoutputNBT,
      ).withCount(1);
      ...
      phoenix.recipes.gtceu
        .melferious_matrix(
          `kubejs:gtceu/simulated_colony/quarry_${type.luv_bee.replace(":", "_")}`,
        )
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(1800)
        .notConsumable(
          IngredientHelper.weakNBT(
            Item.of("productivebees:bee_cage", inputLuVBeeNbt),
          ),
        )
  ...
  function makeBeeCombRecipe({
    ...
    if (outputComb) {
      ...
      const nbt = `{EntityTag:{type:"productivebees:${bee}"}}`;
      output = Item.of("productivebees:configurable_honeycomb", nbt).withCount(
        combCount,
      );
    }
  ...
  BEE_MATERIAL_TYPES.forEach((bee) => {
    if (!beePollinationBlocks[bee]) {
      console.warn(
        `[KubeJS] No pollination block defined for bee type: ${bee}. Skipping recipe.`,
      );
      return;
    }
  ...
  BEE_MATERIAL_TYPES.forEach((bee) => {
    ...
    makeCombDecantingRecipe({
      ...
      bee, // The 'bee' argument is used to construct the NBT for the input comb
      EUt: 4000, // IV tier
      duration: 3600,
  ...
  BEE_MATERIAL_TYPES.forEach((material) => {
    // Using the consistent BEE_MATERIAL_TYPES list
  ...
  function makeHoneyedFluidProcessingRecipe({
    ...
    phoenix.recipes.gtceu
      ...
      .outputFluids(
        `${IMPURE_HONEY_FLUID_ID} ${FINAL_ORE_RECIPE_HONEY_OUTPUT_AMOUNT}`,
      ) // Outputs 500mB of impure honey
  ...
  BEE_MATERIAL_TYPES.forEach((material) => {
    ...
    if (finalOreItemOutputs[material]) {
      ...
      console.warn(
        `[KubeJS] No final ore item defined for honeyed_fluid_processing of material: ${material}`,
      );
    }
  });
});
