ServerEvents.recipes((event) => {
  // Start of the main recipe event listener

  // --- Chemical Reactor Recipes for Custom Fluids ---

  // Recipe for Blazing Drill Fluid (Base)
  event.recipes.gtceu
    .large_chemical_reactor("blazing_drilling_fluid_recipe_base") // Renamed ID
    .inputFluids([
      "gtceu:drilling_fluid 500",
      "minecraft:lava 150",
      "kubejs:cryo_ember_fluid 10000",
    ])
    .itemInputs(["10x gtceu:dormant_ember_dust", "2x gtceu:sulfur_dust"])
  ...
  event.recipes.gtceu
    .large_chemical_reactor("blazing_drilling_fluid_recipe_ignisium") // Renamed ID
  ...
  event.recipes.gtceu
    .large_chemical_reactor("voidic_drilling_fluid_recipe_base") // Renamed ID
    .inputFluids([
      "gtceu:drilling_fluid 500",
      "kubejs:frost 250",
    ...
    .itemInputs(["gtceu:permafrost_dust", "gtceu:ender_eye_dust"])
    .outputFluids("kubejs:voidic_drilling_fluid 1000")
    .duration(300)
    .EUt(GTValues.VA[GTValues.EV] / 2);

  event.recipes.gtceu
    .large_chemical_reactor("voidic_drilling_fluid_recipe_better") // Renamed ID
    .inputFluids(["gtceu:drilling_fluid 500", "gtceu:source_of_magic 1000"])
    .itemInputs(["gtceu:crystallized_fluxstone_dust"])
  ...
  event.recipes.gtceu
    .dimensional_anchoring12("overworld_blazing_drill_better")
    .notConsumable("kubejs:aurum_steel_drilling_kit")
    .notConsumable("kubejs:earthbound_miner_module")
    .inputFluids(["kubejs:blazing_drilling_fluid  8000"])
    .itemOutputs(
  ...
  event.recipes.gtceu
    .dimensional_anchoring12("overworld_blazing_drill_lesser")
    .notConsumable("kubejs:aurum_steel_drilling_kit")
    .inputFluids(["kubejs:blazing_drilling_fluid  8000"])
    .itemOutputs(
  ...
  event.recipes.gtceu
    .dimensional_anchoring12("nether_blazing_drill_better")
  ...
  event.recipes.gtceu
    .dimensional_anchoring12("nether_blazing_drill_lesser_no_module")
    .notConsumable("kubejs:aluminfrost_drilling_kit")
    .inputFluids(["kubejs:blazing_drilling_fluid  8000"])
    .itemOutputs(
  ...
  event.recipes.gtceu
    .dimensional_anchoring12("end_blazing_drill_better")
  ...
  event.recipes.gtceu
    .dimensional_anchoring12("end_blazing_drill_lesser")
    .notConsumable("kubejs:frost_reinforced_stained_steel_drilling_kit")
    .inputFluids(["kubejs:blazing_drilling_fluid  8000"])
    .itemOutputs(
  ...
  event.recipes.gtceu
    .aetherial_fabrication12("moon_voidic_drill_lesser")
    .notConsumable("kubejs:space_grade_steel_drilling_kit")
    .inputFluids(["kubejs:voidic_drilling_fluid  8000"])
    .itemOutputs(
  ...
  event.recipes.gtceu
    .aetherial_fabrication12("moon_voidic_drill_module")
    .notConsumable("kubejs:space_grade_steel_drilling_kit")
  ...
  event.recipes.gtceu
    .chemical_reactor("calcite_generator")
