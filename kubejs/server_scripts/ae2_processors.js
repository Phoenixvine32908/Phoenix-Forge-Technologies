ServerEvents.recipes(event => {
    ...
    const circuitassemblerRecipes = [
        ["processor_logicmv", ["1x ae2:printed_logic_processor", "1x ae2:printed_silicon", "1x #gtceu:circuits/mv", "gtceu:resistor", "2x gtceu:fine_aluminium_wire" ], ["gtceu:soldering_alloy 74"], ["6x ae2:logic_processor"], 600, 64],
        ["processor_logichv", ["1x ae2:printed_logic_processor", "1x ae2:printed_silicon", "1x #gtceu:circuits/hv", "4x gtceu:smd_resistor", "2x gtceu:fine_electrum_wire" ], ["gtceu:soldering_alloy 74"], ["8x ae2:logic_processor"], 600, 256], // Added empty FluidInputs array
