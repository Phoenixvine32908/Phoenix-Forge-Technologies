ServerEvents.recipes((event) => {
  function chemicalReactorRecipe(
    event,
    id,
    inputs,
    fluidInputs,
  ...
  const chemicalReactorRecipes = [
    [
      ...
      ["kubejs:magma 750"],
      ["2x gtceu:blazing_crystal"],
      600,
      64,
    ],
    [
      "energy_steel",
      ["2x gtceu:gold_iron_alloy_ingot", "1x kubejs:flaming_dust"],
      ["gtceu:redstone 100"],
      ["5x gtceu:energy_steel"],
      1200,
      16,
    ],
    [
    ...
    [
      ...
      [
        ...
        "1x gtceu:titanium_block",
      ],
      ["gtceu:redstone 100"],
      ["16x powah:crystal_nitro"],
      400,
      4096,
    ],
  ];

  chemicalReactorRecipes.forEach(
