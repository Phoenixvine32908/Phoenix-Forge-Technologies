ServerEvents.recipes((event) => {
  ...
  event.shaped("sophisticatedbackpacks:backpack", [" N ", "ICI", "N N"], {
    N: "#forge:leather",
  ...
  sophStorageMaterials.forEach((material, toIndex) => {
    ...
    for (let fromIndex = 0; fromIndex < toIndex; fromIndex++) {
      const fromTierName =
        fromIndex == 0 ? "basic_" : sophStorageMaterials[fromIndex][0];
      const prevTierName =
        toIndex - 1 == 0 ? "basic_" : sophStorageMaterials[toIndex - 1][0];
      const toTierName = material[0];
      ...
      event
        .shaped(
          ...
          ["IPI", "ICI", "IPI"],
          {
            ...
            C:
              fromTierName == prevTierName
                ? "minecraft:redstone_torch"
                : `sophisticatedstorage:${fromTierName}to_${prevTierName}tier_upgrade`,
          },
        )
    ...
    sophStorageTypes.forEach((storageType) => {
      ...
      const outputStorage = `sophisticatedstorage:${storageType[0]}${material[0]}${storageType[1]}`;
      const inputStorage = `sophisticatedstorage:${storageType[0]}${sophStorageMaterials[toIndex - 1][0]}${storageType[1]}`;
  ...
  event.shaped("sophisticatedstorage:controller", ["III", "CDC", "IEI"], {
  ...
  event.shaped("sophisticatedstorage:storage_input", ["III", "CDC", "IEI"], {
    I: "#forge:plates/steel",
    C: "#gtceu:circuits/lv",
    D: "#sophisticatedstorage:base_tier_wooden_storage",
    E: "#forge:storage_blocks/gold",
  });
  event.shaped("sophisticatedstorage:storage_output", ["IEI", "CDC", "III"], {
    I: "#forge:plates/steel",
    C: "#gtceu:circuits/lv",
    D: "#sophisticatedstorage:base_tier_wooden_storage",
    E: "#forge:storage_blocks/gold",
  ...
  event.shaped("sophisticatedstorage:storage_io", ["III", "SDT", "III"], {
    I: "#forge:plates/steel",
  ...
  const stackupgrade = [
    ...
    [
      ...
      "gtceu:frost_reinforced_stained_steel",
      "stack_upgrade_tier_1",
    ],
    [
      "stack_upgrade_tier_3",
      "gtceu:void_touched_tungsten_steel",
      "stack_upgrade_tier_2",
    ],
  ...
  stackupgrade.forEach((material) => {
    modids.forEach((mod) => {
      ...
      event.shaped(`${mod}:${material[0]}`, ["III", "IUI", "BIB"], {
        I: `${material[1]}_plate`,
        B: `${material[1]}_gear`,
        U: `${mod}:${material[2]}`,
      });
  ...
  event.shaped(
    "4x sophisticatedstorage:hopper_upgrade",
    [" H ", "IUI", "RRR"],
    {
