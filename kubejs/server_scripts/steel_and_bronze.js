ServerEvents.recipes((event) => {
  ...
  event.shapeless("gtceu:steel_dust", ["1x minecraft:coal", "gtceu:iron_dust"]);
  event.shapeless("gtceu:glass_tube", ["6x minecraft:glass_pane"]);
  event.shapeless("minecraft:crying_obsidian", ["1x minecraft:obsidian"]);
  ...
  event.shapeless("1x gtceu:programmed_circuit", ["#gtceu:circuits"]);
  ...
  event.shapeless("gtceu:steel_dust", ["1x gtceu:coke", "gtceu:iron_dust"]);
  event.shapeless("gtceu:steel_dust", [
    "1x gtceu:coke",
    "gtceu:wrought_iron_dust",
  ]);
...
function alloySmelterRecipe(event, id, inputs, outputs, dur, power) {
  const rec = event.recipes.gtceu.alloy_smelter(id).duration(dur).EUt(power);
...
ServerEvents.recipes((event) => {
  const alloySmelterRecipes = [
    [
      "steel_ingot_coal_iron_ingot",
      ["1x minecraft:coal", "1x minecraft:iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_charcoal_iron_ingot",
      ["1x minecraft:charcoal", "1x minecraft:iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_coal_dust_iron_ingot",
      ["1x #forge:dusts/coal", "1x minecraft:iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_coal_dust_iron_dust",
      ["1x #forge:dusts/coal", "1x gtceu:iron_dust"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_coal_dust_wrought_iron_ingot",
      ["1x #forge:dusts/coal", "1x gtceu:wrought_iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_coal_wrought_iron_ingot",
      ["1x minecraft:coal", "1x gtceu:wrought_iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_coke_dust_iron_ingot",
      ["1x gtceu:coke_dust", "1x minecraft:iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_coal_dust_wrought_iron_ingot_gt",
      ["1x gtceu:coal_dust", "1x gtceu:wrought_iron_ingot"],
      ["1x gtceu:steel_ingot"],
      100,
      7,
    ],
    [
      "steel_ingot_coke_iron_ingot",
      ["1x gtceu:coke_gem", "1x minecraft:iron_ingot"],
      ["1x gtceu:steel_ingot"],
      100,
      7,
    ],
    [
      "steel_ingot_charcoal_wrought_iron_ingot",
      ["1x minecraft:charcoal", "1x gtceu:wrought_iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_charcoal_dust_iron_ingot",
      ["1x gtceu:charcoal_dust", "1x minecraft:iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    [
      "steel_ingot_coke_wrought_iron_ingot_gt",
      ["1x gtceu:coke_gem", "1x gtceu:wrought_iron_ingot"],
      ["1x gtceu:steel_ingot"],
      100,
      7,
    ],
    [
      "steel_ingot_charcoal_dust_wrought_iron_ingot_gt",
      ["1x gtceu:charcoal_dust", "1x gtceu:wrought_iron_ingot"],
      ["1x gtceu:steel_ingot"],
      200,
      7,
    ],
    ...
    [
      "steel_block1",
      ["1x minecraft:coal_block", "1x minecraft:iron_block"],
  ...
  const mixerRecipes = [
    [
      "fiery_bronze_dust_from_mixer",
      [
        "3x gtceu:copper_dust",
        "1x gtceu:tin_dust",
        "1x gtceu:dormant_ember_dust",
      ],
      ["4x gtceu:fiery_bronze_dust"],
      300,
      7,
      4,
    ],
    [
      "aurum_steel_dust_from_mixer",
      [
        "2x gtceu:steel_dust",
        "1x gtceu:gold_dust",
        "2x gtceu:dormant_ember_dust",
      ...
      ["5x gtceu:aurum_steel_dust"],
      300,
      7,
      2,
    ],
    [
      "unrefined_aluminfrost_dust_from_mixe",
      ["2x gtceu:aluminium_dust", "1x gtceu:permafrost_dust"],
