...
GTCEuServerEvents.oreVeins((event) => {
  event.add("overworld/heat_frost", (vein) => {
    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          .layer((l) =>
            l.weight(2).mat(GTMaterials.get("permafrost")).size(2, 2),
          )
          .layer((l) =>
            l.weight(2).mat(GTMaterials.get("dormant_ember")).size(1, 2),
          )
          .layer((l) =>
            l
              .weight(1)
              .state(() =>
                Block.getBlock("minecraft:magma_block").defaultBlockState(),
              )
              .size(2, 3),
          ),
      ),
  ...
  event.add("moon/fluorite", (vein) => {
    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          ...
          .layer((l) =>
            l.weight(35).mat(GTMaterials.get("fluorite")).size(1, 2),
          ),
      ),
    );
    vein.surfaceIndicatorGenerator((indicator) =>
      indicator.surfaceRock(GTMaterials.get("fluorite")).placement("above"),
    );
    ...
    event.add("moon/bauxite", (vein) => {
      ...
      vein.surfaceIndicatorGenerator((indicator) =>
        indicator.surfaceRock(GTMaterials.Bauxite).placement("above"),
      );
    });
    event.add("moon/tungsten", (vein) => {
      ...
      vein.surfaceIndicatorGenerator((indicator) =>
        indicator.surfaceRock(GTMaterials.Scheelite).placement("above"),
      );
    });
  });
  event.add("moon/magical_ores", (vein) => {
    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          .layer((l) =>
            l.weight(35).mat(GTMaterials.get("nevvonian_iron")).size(1, 2),
          )
          .layer((l) =>
            l
              .weight(20)
              .mat(GTMaterials.get("polarity_flipped_bismuthite"))
              .size(1, 2),
          )
          .layer((l) =>
            l.weight(25).mat(GTMaterials.get("voidglass_shard")).size(1, 2),
          ),
      ),
    );
    vein.surfaceIndicatorGenerator((indicator) =>
