...
ServerEvents.recipes((event) => {
  ...
  // Specialized Drawers
  event
    .shaped("functionalstorage:controller_extension", ["III", "CDC", "IGI"], {
      I: "gtceu:iron_plate",
      C: "#gtceu:circuits/lv",
  ...
  event
    .shaped("functionalstorage:armory_cabinet", ["ICI", "PDP", "III"], {
      I: "gtceu:iron_plate",
      C: "#gtceu:circuits/hv",
      D: "#functionalstorage:drawer",
  ...
  event
    .shaped("functionalstorage:ender_drawer", ["ICI", "PEP", "III"], {
      I: "gtceu:iron_plate",
      C: "#gtceu:circuits/mv",
  ...
  miscframing.forEach((Block) => {
    event
      .shaped(`functionalstorage:framed_${Block}`, ["III", "IBI", "III"], {
        ...
        ["PUP", "PGP", "PUP"],
        {
          ...
          U:
            tierIndex == 0
              ...
              : `functionalstorage:${upgradeTiers[tierIndex - 1][0]}_upgrade`,
        },
      )
