...
ServerEvents.recipes(event => {
    ...
    const rotorReplacements = {
        ...
        HV: {
            oldRotor: "gtceu:stainless_steel_rotor",
            newRotor: "gtceu:frost_reinforced_stained_steel_rotor"
        },
        EV: {
            oldRotor: "gtceu:titanium_rotor",
            newRotor: "gtceu:source_imbued_titanium_rotor"
        },
    };
