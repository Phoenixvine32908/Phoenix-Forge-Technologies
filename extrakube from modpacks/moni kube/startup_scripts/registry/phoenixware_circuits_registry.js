...
StartupEvents.registry('item', event => {
    ...
    .texture('kubejs:item/phoenixware/perfected_phoenixware_processor_mainframe')
    ...
    .texture('kubejs:item/phoenixware/perfected_phoenixware_processing_unit')
    .displayName("§6Perfected PhoenixWare Processing Unit – “Phoenix Based Zeroth Component”")
    .glow(true)
    event.create('perfected_phoenixware_processor_super_computer')
    .texture('kubejs:item/phoenixware/perfected_phoenixware_processor_super_computer')
    ...
    .texture('kubejs:item/phoenixware/perfected_phoenixware_processor_assembly')
    ...
    .texture('kubejs:item/phoenixware/perfected_phoenixware_processor')
    ...
    .texture('kubejs:item/phoenixware/flawed_phoenixware_processor_assembly')
    .displayName("§6Flawed PhoenixWare Assembly – “Inertial Quantum Array”")
    .tag("gtceu:circuits/uv")
    event.create('flawed_phoenixware_processor_super_computer')
    .texture('kubejs:item/phoenixware/flawed_phoenixware_processor_super_computer')
    .displayName("§6Flawed PhoenixWare Supercomputer – “Echo Resonance Grid”")
    .tag("gtceu:circuits/uhv")
    event.create('flawed_phoenixware_processor_mainframe')
    .texture('kubejs:item/phoenixware/flawed_phoenixware_processor_mainframe')
    .displayName("§6Flawed PhoenixWare Mainframe – “Asynchronous Singularity Core”")
    .tag("gtceu:circuits/uev")
    flawed("phoenixware_processing_unit", "§6Flawed PhoenixWare Processing Unit – “Inferno Seed”");
    flawed("phoenixware_circuit_board", "§6Flawed PhoenixWare Circuit Board – “Flickerweave”");
    flawed("phoenixware_printed_board", "§6Flawed PhoenixWare Printed Circuit Board – “Cracked Plume”");


    // Unstable Processing Unit
    event.create('unstable_processing_unit')
    .texture('kubejs:item/phoenixware/unstable_processing_unit')
